            ...
            if (filter_var($pdf, FILTER_VALIDATE_URL)) {
                ...
                switch ($output) {
                    ...
                    default:
                        ...
                        if ($preload) {
                            $response = '<iframe name="' . md5($this->helper->get('version')) . '" onload="e2pdfViewer.iframeLoad(this)" style="' . esc_attr(implode(';', $style)) . '" class="' . esc_attr(implode(' ', $classes)) . '" width="' . esc_attr($width) . '" height="' . esc_attr($height) . '" preload="' . $viewer_url . '"></iframe>';
                        } else {
                            $response = '<iframe name="' . md5($this->helper->get('version')) . '" onload="e2pdfViewer.iframeLoad(this)" style="' . esc_attr(implode(';', $style)) . '" class="' . esc_attr(implode(' ', $classes)) . '" width="' . esc_attr($width) . '" height="' . esc_attr($height) . '" src="' . $viewer_url . '"></iframe>';
                        }
                        break;
                }
            } else {
