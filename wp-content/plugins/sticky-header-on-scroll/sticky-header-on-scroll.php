...
*/
	...
	function shos_theme_customizer( $wp_customize ) {
        ...
        //
        $wp_customize->add_panel('shos_panel', array('title' => esc_html__('Sticky Header on Scroll Plugin', 'shos'),'priority' => 10,));
        
        //
        // ADD "Header Bar" SECTION TO "Sticky Header on Scroll Plugin" PANEL 
        //
        $wp_customize->add_section('shos_header_section',array('title' => esc_html__( 'Header Bar', 'shos' ),'panel'  => 'shos_panel','priority' => 1));
        ...
        $wp_customize->add_control('shos_header_height',array(
            'type' => 'text',
            'label' => esc_html__('Header height (in pixels)', 'shos'),
            'description' => esc_html__('Example: 75. If empty, defaults to 66. Recommended only if you want to make header larger. Alternatively, use the slim design option below.', 'shos'),
            'section' => 'shos_header_section',
        ));
        
        /* slim design */
        $wp_customize->add_setting('shos_slim_design',array('sanitize_callback' => 'sanitize_shos_slim_design',));
        function sanitize_shos_slim_design( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
        $wp_customize->add_control('shos_slim_design',array('type' => 'checkbox','label' => esc_html__('Slim design', 'shos'),'description' => esc_html__('If enabled, the custom height setting above will be ignored.', 'shos'), 'section' => 'shos_header_section',));
        ...
        $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'shos_header_bg_image',
            array(
                'label' => esc_html__('Header background image', 'shos'),
        ...
        function sanitize_shos_header_bg_image_cover( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
        $wp_customize->add_control('shos_header_bg_image_cover',array('type' => 'checkbox','label' => esc_html__('Full background', 'shos'),'description' => esc_html__('By default, the background image will be shown as a pattern. If this option is selected, it will be displayed as a full background instead.', 'shos'),'section' => 'shos_header_section',));
        ...
        $wp_customize->add_control('shos_header_bg_image_opacity',array(
            'type' => 'text',
            'label' => esc_html__('Header background image opacity', 'shos'),
            'description' => esc_html__('Example: 0.5 or 0.75. If empty, defaults to 0.1', 'shos'),
            'section' => 'shos_header_section',
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_header_color',array(
            'label' => esc_html__('Header background', 'shos'), 'settings' => 'shos_header_color', 'section' => 'shos_header_section' )
        ));
        ...
        $wp_customize->add_control('shos_header_opacity',array(
            'type' => 'text',
            'label' => esc_html__('Header opacity', 'shos'),
            'description' => esc_html__('From 0-1 (example: 0.95) If empty, defaults to 1', 'shos'),
            'section' => 'shos_header_section',
        ));
        ...
        //
        $wp_customize->add_section('shos_logo_section',array('title' => esc_html__( 'Logo', 'shos' ),'panel'  => 'shos_panel','priority' => 1));
        
        /* hide logo */
        $wp_customize->add_setting('shos_hide_logo',array('sanitize_callback' => 'sanitize_shos_hide_logo',));
        function sanitize_shos_hide_logo( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
        $wp_customize->add_control('shos_hide_logo',array('type' => 'checkbox','label' => esc_html__('Hide logo', 'shos'),'description' => esc_html__('If ticked, logo will not be displayed.', 'shos'), 'section' => 'shos_logo_section',));
        ...
        $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'shos_logo_image',
            array(
                'label' => esc_html__('Upload logo image', 'shos'),
        ...
        $wp_customize->add_control('shos_logo_height',array(
            'type' => 'text',
            'label' => esc_html__('Logo height (in pixels)', 'shos'),
            'description' => esc_html__('Example: 30. If empty, defaults to 45. Logo width will remain proportional to height.', 'shos'),
            'section' => 'shos_logo_section',
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_logo_color',array(
            'label' => esc_html__('Logo', 'shos'), 'settings' => 'shos_logo_color', 'section' => 'shos_logo_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_logo_hover_color',array(
            'label' => esc_html__('Logo hover', 'shos'), 'settings' => 'shos_logo_hover_color', 'section' => 'shos_logo_section' )
        ));
        
        //
        // ADD "Menu Button" SECTION TO "Sticky Header on Scroll Plugin" PANEL 
        //
        $wp_customize->add_section('shos_menu_button_section',array('title' => esc_html__( 'Menu Button', 'shos' ),'panel'  => 'shos_panel','priority' => 1));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_button_color',array(
            'label' => esc_html__('Menu button', 'shos'), 'settings' => 'shos_main_menu_button_color', 'section' => 'shos_menu_button_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_button_hover_color',array(
            'label' => esc_html__('Menu button (hover, active)', 'shos'), 'settings' => 'shos_main_menu_button_hover_color', 'section' => 'shos_menu_button_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_button_bg_color',array(
            'label' => esc_html__('Menu button background', 'shos'), 'settings' => 'shos_main_menu_button_bg_color', 'description' => 'Applied only when slim design enabled (in the "Header Bar" section).', 'section' => 'shos_menu_button_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_button_bg_hover_color',array(
            'label' => esc_html__('Menu button background (hover, active)', 'shos'), 'settings' => 'shos_main_menu_button_bg_hover_color', 'description' => 'Applied only when slim design enabled (in the "Header Bar" section).', 'section' => 'shos_menu_button_section' )
        ));
        ...
        $wp_customize->add_control('shos_menu_button_label',array(
            'type' => 'text',
            'label' => esc_html__('Menu button label', 'shos'),
            'description' => esc_html__('An optional text label to be shown below menu button (for example: MENU).', 'shos'),
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_button_label_color',array(
            'label' => esc_html__('Menu button label', 'shos'), 'settings' => 'shos_main_menu_button_label_color', 'section' => 'shos_menu_button_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_button_label_hover_color',array(
            'label' => esc_html__('Menu button label (hover, active)', 'shos'), 'settings' => 'shos_main_menu_button_label_hover_color', 'section' => 'shos_menu_button_section' )
        ));

        //
        // ADD "Dropdown Menu" SECTION TO "Sticky Header on Scroll Plugin" PANEL 
        //
        $wp_customize->add_section('shos_dropdown_section',array('title' => esc_html__( 'Dropdown Menu', 'shos' ),'panel'  => 'shos_panel','priority' => 1));
        ...
        $wp_customize->add_control('shos_menu_max_width',array(
            'type' => 'text',
            'label' => esc_html__('Dropdown menu max width (in pixels)', 'shos'),
            'description' => esc_html__('Set maximum width for dropdown menu. If left empty, defaults to 300.', 'shos'),
        ...
        $wp_customize->add_control('shos_menu_max_height',array(
            'type' => 'text',
            'label' => esc_html__('Dropdown menu max height (in pixels)', 'shos'),
            'description' => esc_html__('Set maximum height for dropdown menu. If left empty, defaults to full size.', 'shos'),
            'section' => 'shos_dropdown_section',
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_color',array(
            'label' => esc_html__('Menu item', 'shos'), 'settings' => 'shos_main_menu_color', 'section' => 'shos_dropdown_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_hover_color',array(
            'label' => esc_html__('Menu item (hover)', 'shos'), 'settings' => 'shos_main_menu_hover_color', 'section' => 'shos_dropdown_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize,'shos_expand_icon_separator_color',array(
            'label' => esc_html__('Expand icon separator', 'shos'),'settings' => 'shos_expand_icon_separator_color','section' => 'shos_dropdown_section')
		));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize,'shos_expand_icon_color',array(
            'label' => esc_html__('Expand icon', 'shos'),'settings' => 'shos_expand_icon_color','section' => 'shos_dropdown_section')
		));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize,'shos_expand_icon_hover_color',array(
            'label' => esc_html__('Expand icon (hover)', 'shos'),'settings' => 'shos_expand_icon_hover_color','section' => 'shos_dropdown_section')
		));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_divider_color',array(
            'label' => esc_html__('Menu item dividers', 'shos'), 'settings' => 'shos_main_menu_divider_color', 'section' => 'shos_dropdown_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_submenu_color',array(
            'label' => esc_html__('Submenu item', 'shos'), 'settings' => 'shos_submenu_color', 'section' => 'shos_dropdown_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_submenu_hover_color',array(
            'label' => esc_html__('Submenu item (hover)', 'shos'), 'settings' => 'shos_submenu_hover_color', 'section' => 'shos_dropdown_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize,'shos_submenu_expand_icon_separator_color',array(
            'label' => esc_html__('Expand icon separator (sub-menu)', 'shos'),'settings' => 'shos_submenu_expand_icon_separator_color','section' => 'shos_dropdown_section')
		));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize,'shos_submenu_expand_icon_color',array(
            'label' => esc_html__('Expand icon (sub-menu)', 'shos'),'settings' => 'shos_submenu_expand_icon_color','section' => 'shos_dropdown_section')
		));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize,'shos_submenu_expand_icon_hover_color',array(
            'label' => esc_html__('Expand icon (hover, sub-menu)', 'shos'),'settings' => 'shos_submenu_expand_icon_hover_color','section' => 'shos_dropdown_section')
		));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_submenu_divider_color',array(
            'label' => esc_html__('Submenu item dividers', 'shos'), 'settings' => 'shos_submenu_divider_color', 'section' => 'shos_dropdown_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_main_menu_background_color',array(
            'label' => esc_html__('Menu background', 'shos'), 'settings' => 'shos_main_menu_background_color', 'section' => 'shos_dropdown_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_submenu_background_color',array(
            'label' => esc_html__('Submenu background', 'shos'), 'settings' => 'shos_submenu_background_color', 'section' => 'shos_dropdown_section' )
        ));
        
        //
        // ADD "Post title" SECTION TO "Sticky Header on Scroll Plugin" PANEL 
        //
        $wp_customize->add_section('shos_post_title_section',array('title' => esc_html__( 'Post Title', 'shos' ),'panel'  => 'shos_panel','priority' => 1));
        
        /* hide post title */
        $wp_customize->add_setting('shos_hide_post_title',array('sanitize_callback' => 'sanitize_shos_hide_post_title',));
        function sanitize_shos_hide_post_title( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
        $wp_customize->add_control('shos_hide_post_title',array('type' => 'checkbox','label' => esc_html__('Hide post title', 'shos'),'description' => esc_html__('By default, when viewing a post, the post title is displayed in the header. If you wish it to be hidden, enable this option.', 'shos'), 'section' => 'shos_post_title_section',));
        ...
        $wp_customize->add_control('shos_post_title_prefix',array(
            'type' => 'text',
            'label' => esc_html__('Post title prefix', 'shos'),
            'description' => esc_html__('If left empty, no prefix is shown.', 'shos'),
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_post_title_prefix_color',array(
            'label' => esc_html__('Post title prefix', 'shos'), 'settings' => 'shos_post_title_prefix_color', 'section' => 'shos_post_title_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_post_title_color',array(
            'label' => esc_html__('Post title', 'shos'), 'settings' => 'shos_post_title_color', 'section' => 'shos_post_title_section' )
        ));
        
        //
        // ADD "Share Buttons" SECTION TO "Sticky Header on Scroll Plugin" PANEL 
        //
        $wp_customize->add_section('shos_share_buttons_section',array('title' => esc_html__( 'Share Buttons', 'shos' ),'panel'  => 'shos_panel','priority' => 1));
        
        /* hide share buttons */
        $wp_customize->add_setting('shos_hide_share_buttons',array('sanitize_callback' => 'sanitize_shos_hide_share_buttons',));
        function sanitize_shos_hide_share_buttons( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
        $wp_customize->add_control('shos_hide_share_buttons',array('type' => 'checkbox','label' => esc_html__('Hide share buttons', 'shos'),'description' => esc_html__('By default, when viewing a post, the share buttons are displayed in the header. If you wish them to be hidden, enable this option.', 'shos'), 'section' => 'shos_share_buttons_section',));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize, 'shos_more_share_buttons_color',array(
            'label' => esc_html__('’More buttons’ button color', 'shos'), 'settings' => 'shos_more_share_buttons_color', 'section' => 'shos_share_buttons_section' )
        ));

        //
        // ADD "STYLED SCROLLBAR" SECTION TO "Sticky Header on Scroll Plugin" PANEL 
        //
        $wp_customize->add_section('shos_scrollbar_section',array('title' => esc_html__( 'Styled Scrollbar', 'minimenu' ), 'description' => 'Note: Styled scrollbar is not displayed on touch devices.','panel'  => 'shos_panel','priority' => 1));
        ...
        function sanitize_shos_styled_scrollbar( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
        $wp_customize->add_control('shos_styled_scrollbar',array('type' => 'checkbox','label' => esc_html__('Enable styled scrollbar', 'shos'),'description' => esc_html__('If unticked, the default scrollbar of a browser is used.', 'shos'), 'section' => 'shos_scrollbar_section',));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_scrollbar_color',array(
            'label' => esc_html__('Scrollbar', 'shos'), 'settings' => 'shos_scrollbar_color', 'section' => 'shos_scrollbar_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_scrollbar_background_color',array(
            'label' => esc_html__('Scrollbar background', 'shos'), 'settings' => 'shos_scrollbar_background_color', 'section' => 'shos_scrollbar_section' )
        ));

        //
        // ADD "Misc" SECTION TO "Sticky Header on Scroll Plugin" PANEL 
        //
        $wp_customize->add_section('shos_misc_section',array('title' => esc_html__( 'Misc', 'shos' ),'panel'  => 'shos_panel','priority' => 1));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_divider_color',array(
            'label' => esc_html__('Dividers', 'shos'), 'settings' => 'shos_divider_color', 'section' => 'shos_misc_section' )
        ));
        
        /* hide dividers */
        $wp_customize->add_setting('shos_hide_dividers',array('sanitize_callback' => 'sanitize_shos_hide_dividers',));
        function sanitize_shos_hide_dividers( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
        $wp_customize->add_control('shos_hide_dividers',array('type' => 'checkbox','label' => esc_html__('Hide menu button and logo dividers', 'shos'), 'section' => 'shos_misc_section',));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_next_button_color',array(
            'label' => esc_html__('"Next" button', 'shos'), 'settings' => 'shos_next_button_color', 'section' => 'shos_misc_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'shos_next_button_background_color',array(
            'label' => esc_html__('"Next" button background', 'shos'), 'settings' => 'shos_next_button_background_color', 'section' => 'shos_misc_section' )
        ));
        ...
        function sanitize_shos_hide_next_post_button( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
        $wp_customize->add_control('shos_hide_next_post_button',array('type' => 'checkbox','label' => esc_html__('Hide "Next" button', 'shos'),'description' => esc_html__('By default, when viewing a post, the "Next" button is displayed in the header. If you wish it to be hidden, enable this option.', 'shos'), 'section' => 'shos_misc_section',));
        ...
        $wp_customize->add_control('shos_display_after',array(
            'type' => 'text',
            'label' => esc_html__('Display after scrolling X amount (in pixels)', 'shos'),
            'description' => esc_html__('The amount of distance the user has to scroll before the sticky header appears. Example: 50 or 250. By default, header will appear after scrolling 100 pixels.', 'shos'),
        ...
        $wp_customize->add_control('shos_smaller_than',array(
            'type' => 'text',
            'label' => esc_html__('Hide at certain width/resolution', 'shos'),
            'description' => wp_kses( __('<strong>Example #1:</strong> If you want to show Sticky Header on Scroll on desktop only, enter the values as 0 and 500. <br><br> <strong>Example #2:</strong> If you want to show Sticky Header on Scroll on mobile only, enter the values as 500 and 5000. <br><br> Feel free to experiment with your own values to get the result that is right for you. If fields are empty, Sticky Header on Scroll will be visible at all browser widths and resolutions. <br><br> Hide Sticky Header on Scroll if browser width or screen resolution (in pixels) is between...', 'shos'), $allowed_html_array ),
            'section' => 'shos_misc_section',
        ));
        ...
        $wp_customize->add_control('shos_larger_than',array(
            'type' => 'text',
            'description' => esc_html__('..and:', 'shos'),
            'section' => 'shos_misc_section',
        ));
        ...
        $wp_customize->add_control('shos_hide_theme_header',array(
            'type' => 'text',
            'label' => esc_html__('Advanced: Hide theme header', 'shos'),
            'description' => esc_html__('If you know the class/ID of your theme header and would like to hide it (or any other element for that matter), enter the class/ID into this field (example: "#my-theme-header"). Multiple classes/IDs can be entered (separate with comma as you would in a stylesheet).', 'shos'),
            'section' => 'shos_misc_section',
        ));
...
<?php
                ...
                <div class="shos-share-wrapper">
                    <div class="shos-share-inner">
                        ...
                        <a href="http://www.facebook.com/sharer.php?u=<?php echo esc_url( get_permalink() ); ?>" target="_blank" class="shos-facebook-button">
                            <span class="shos-icon-facebook"></span><span class="shos-share-label"><?php esc_html__('SHARE','shos'); ?></span>
                        </a>
                        <!-- END FACEBOOK BUTTON -->
                        ...
                        <a href="http://twitter.com/share?url=<?php echo esc_url( get_permalink() ); ?>&text=<?php the_title(); ?>" target="_blank" class="shos-twitter-button">
                            <span class="shos-icon-twitter"></span><span class="shos-share-label"><?php esc_html__('TWEET','shos'); ?></span>
                        </a>
                        <!-- END TWITTER BUTTON -->
	...
	if (function_exists('register_nav_menus')) {
		register_nav_menus( array(
            'shos-by-bonfire' => esc_html__('Sticky Header on Scroll', 'shos'),
		) );
	}
	...
	// Translation-ready
	//
    function shos_load_plugin_textdomain() {
        load_plugin_textdomain( 'shos', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
    }
    add_action( 'plugins_loaded', 'shos_load_plugin_textdomain' );
